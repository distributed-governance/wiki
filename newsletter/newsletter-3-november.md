...
* Colony: is preparing to go live this year, check out the [BugBounty](https://blog.colony.io/announcing-the-colony-network-bug-bounty-f44cabaca9a3/) and interview with [Jack Du Rose](https://soundcloud.com/arthurfalls/the-third-web-10-jack-du-rose-colony-coase). Also published [the primer on the colonyNetwork contracts](https://blog.colony.io/for-whom-the-delegate-calls/)
